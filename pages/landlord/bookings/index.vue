<template>
  <v-card :loading="loading" class="mx-auto my-12 txt" max-width="374">
    <v-img height="250" src="/apartment.jpg"></v-img>
    ...
    <div class="ma-2">
      <v-card-actions>
        <v-btn color="#ec7d10" class="white--text" @click="snackbar = true">Confirm</v-btn>
        <v-btn color="yellow darken-4" outlined text @click="reserve">Chat</v-btn>
      </v-card-actions>
    ...
    <v-card-title class="black--text">Reschedule</v-card-title>
